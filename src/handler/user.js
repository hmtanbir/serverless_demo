...
//createUser
// curl --location --request POST 'http://localhost:3000/dev/api/v1/users' \
...
// updateUser
// curl --location --request PUT 'http://localhost:3000/dev/api/v1/users/658ed19939d8030c89959bd7' \
// --header 'Content-Type: application/json' \
// --data-raw '{
//     "body": {
//         "username": "alex2",
...
// deleteUser
// curl --location --request DELETE 'http://localhost:3000/dev/api/v1/users/658ed19939d8030c89959bd7' \
// --header 'Content-Type: application/json' \
